...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self,train_array,test_array):
        try:
             ...
             #mlflow.set_registry_uri("")  # if we want to store the registry in cloud then used it, for now  we are storing in local
             ...
             with mlflow.start_run():
                ...
                if tracking_url_type_store != "file":
                    ...
                    mlflow.sklearn.log_model(model, "model", registered_model_name="ml_model")  # for log in cloud if file is not found
                else:
                    mlflow.sklearn.log_model(model, "model")  # for log in our local
